...
export function NavLink(props) {
	if (props.to) {
		...
		return (
			<span className={props.className + " block"}>{props.children}</span>
		);
	}
}
			...
			>
				<div className="flex-1 flex text-2xl px-2">
					<div className="flex-1">
						<NavLink
							to="/"
							className="hover:underline active:scale-110"
					...
					<div className="self-end justify-self-end">
						<button className="md:hidden" onClick={navbarToggle}>
